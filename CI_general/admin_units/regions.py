...
##############################################################################################
### here we just plot the regions and subprefs on the map with the ids
##############################################################################################
...
for npoly in range(shp.info()[0]):
    ...
    colorVal = scalarMap.to_rgba(values[subpref_region[subpref_id]])
...
plt.savefig('/home/sscepano/Project7s/D4D/CI/admin_units/regions_and_poles/regions.png',dpi=700)
